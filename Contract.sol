...
contract CoolFrens is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmaqu7wNu4AMqYvFYwNp4yeTh8dCyJ369t7BMPj4zZHxSg";
    ...
    constructor(
    ) ERC721A("CoolFrens", "POKI", 100, maxSupply) {
    }

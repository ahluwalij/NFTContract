...
contract Name is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://REPLACE";
    address private openSeaProxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    bool private isOpenSeaProxyActive = true;

    uint256 public constant MAX_MINTS_PER_TX = __;
    uint256 public constant MAX_MINTS_PER_WALLET = __;
    uint256 public maxSupply = __;

    uint256 public constant PUBLIC_SALE_PRICE = __ ether;
    uint256 public NUM_FREE_MINTS = __;
